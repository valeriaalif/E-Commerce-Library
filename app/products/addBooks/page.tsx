...
const AddProductForm = () => {
  return (
    ...
    <div className="grid gap-3 lg:grid-cols-2">
      <div>
        ...
        <div className="relative w-56 mt-2 bg-gray-100 rounded-lg">
          ...
          <label className="flex w-full cursor-pointer rounded-lg select-none border p-2 px-3 text-sm text-gray-700 ring-blue-400 peer-checked:ring">Select Option </label>
    ...
    <div className="checkbox">
      ...
      <label>I agree to the <a href="#" target="_blank" className="text-blue-600"> Terms and Conditions </a> </label>
    </div>
